...
The role reconciles buckets, policies, users, groups, service accounts, policy
bindings, and finally site replication. This permits policies and later
resources to reference earlier ones. Empty resource lists are no-ops, and
